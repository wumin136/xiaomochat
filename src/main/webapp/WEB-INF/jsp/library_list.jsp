...
<table class="easyui-datagrid" id="orderList" title="聊天库信息" data-options="singleSelect:false,collapsible:true,
	pagination:true,rownumbers:true,url:'order/list',method:'get',pageSize:10,fitColumns:true,toolbar:toolbar_order">
    <thead>
        <tr>
			<th data-options="field:'ck',checkbox:true"></th>
			<th data-options="field:'orderId',align:'center',width:100">聊天库编号</th>
			<th data-options="field:'custom',align:'center',width:100,formatter:formatCustom">聊天库名称</th>
			<th data-options="field:'status',width:60,align:'center',formatter:TAOTAO.formatOrderStatus">聊天库类别</th>
			<th data-options="field:'status',width:60,align:'center',formatter:TAOTAO.formatOrderStatus">所属范畴</th>
			<th data-options="field:'orderDate',width:130,align:'center',formatter:TAOTAO.formatDateTime">创建日期</th>
			<th data-options="field:'orderId',align:'center',width:100">聊天库创建人</th>
			<th data-options="field:'file',width:180,align:'center', formatter:formatFile">聊天库文件</th>
        </tr>
    </thead>
</table> 
...
<div  id="toolbar_order" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_order" style="float: right;">
        ...
        <div id="menu_order" style="width:120px"> 
			<div data-options="name:'orderId'">聊天库编号</div>
			<div data-options="name:'orderCustom'">聊天库名称</div>
			<div data-options="name:'orderProduct'">聊天库类别</div>
			<div data-options="name:'orderCustom'">所属范畴</div>
		</div>     
    </div>  
</div>  

<div id="orderEditWindow" class="easyui-window" title="编辑聊天库" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'order/edit'" style="width:65%;height:80%;padding:10px;">
</div>
<div id="orderAddWindow" class="easyui-window" title="添加聊天库" data-options="modal:true,closed:true,resizable:true,
...
function doSearch_order(value,name){ //用户输入用户名,点击搜素,触发此函数  
	if(value == null || value == ''){
		...
		$("#orderList").datagrid({
	        title:'聊天库信息', singleSelect:false, collapsible:true, pagination:true, rownumbers:true, method:'get',
			nowrap:true, toolbar:"toolbar_order", url:'order/list', method:'get', loadMsg:'数据加载中......',
			fitColumns:true,//允许表格自动缩放,以适应父容器
	        columns : [ [ 
				{field : 'ck', checkbox:true },
				{field : 'orderId', width : 100, align:'center', title : '聊天库编号'},
				{field : 'custom', width : 100, align : 'center', title : '聊天库名称', formatter:formatCustom},
				{field : 'status', width : 60, title : '聊天库类型', align:'center', formatter:TAOTAO.formatOrderStatus},
                {field : 'product', width : 100, align : 'center', title : '所属范畴', formatter:formatProduct},
                {field : 'orderDate', width : 130, title : '创建日期', align:'center', formatter:TAOTAO.formatDateTime},
                {field : 'orderId', width : 100, align:'center', title : '聊天库创建人'},
                {field : 'file',  width : 100, title : '聊天库文件', align:'center', formatter:formatFile}
	        ] ],  
	    });
	}else{
		$("#orderList").datagrid({
