...
<table class="easyui-datagrid" id="userList" title="管理员列表"
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'id',align:'center',width:150">管理员编号</th>
            <th data-options="field:'username',align:'center',width:150">管理员用户名</th>
...
<div  id="toolbar_user" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_user" style="float: right;">
        ...
        <div id="menu_user" style="width:120px"> 
			<div data-options="name:'userId'">管理员编号</div>
			<div data-options="name:'userName'">管理员名称</div>
...
<div id="userEditWindow" class="easyui-window" title="编辑管理员" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'user/edit'" style="width:45%;height:60%;padding:10px;">
</div>
<div id="userAddWindow" class="easyui-window" title="添加管理员" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'user/add'" style="width:45%;height:60%;padding:10px;">
</div>
<div id="userRoleWindow" class="easyui-window" title="添加管理员角色" data-options="modal:true,closed:true,resizable:true,
	...
	if(value == null || value == ''){
		$("#userList").datagrid({
	        ...
	        columns : [ [ 
				...
				{field : 'id', width : 150, align:'center', title : '管理员编号'},
				{field : 'username', width : 150, align : 'center', title : '管理员名称'},
